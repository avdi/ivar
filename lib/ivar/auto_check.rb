...
module Ivar
  ...
  # When included, automatically calls check_ivars with warn_once policy
  module CheckedOnce
    # When this module is included in a class, it extends the class
    # with ClassMethods and includes the Validation module
    def self.included(base)
      ...
      # Set default policy for CheckedOnce to :warn_once
      base.ivar_check_policy(:warn_once)
    end
    ...
    # Instance methods that will be prepended to the including class
    module InstanceMethods
      # Wrap the initialize method to automatically call check_ivars with warn_once policy
      def initialize(*args, **kwargs, &block)
        # Initialize pre-declared instance variables
        initialize_pre_declared_ivars
        # Execute the initialization block if provided
        ...
        # Automatically check instance variables with the class policy
        check_ivars
      end
    end
  end
